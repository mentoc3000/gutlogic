...
class Routes {
  ...
  Route createPantryEntryPageRouteForReference(PantryEntryReference pantryEntryReference) {
    return MaterialPageRoute(builder: (context) => PantryEntryPage.forPantryEntryReference(pantryEntryReference));
  }
}
