...
abstract class SymptomType
    implements Built<SymptomType, SymptomTypeBuilder>, Searchable {
  ...
  factory SymptomType.fromBuilder([updates(SymptomTypeBuilder b)]) =
      _$SymptomType;

  String searchHeading() => this.name;
  String queryText() => this.name;
}
